...
# ==============================================================================
element = Element("element", Frame.worldXY(), geometry_simplified=Point(0, 0, 0), geometry=Mesh.from_polyhedron(6))
...
print(element.to_jsonstring(pretty=True))
element.to_json("data/element.json", pretty=True)
element.from_json("data/element.json")
os.remove("data/element.json")
